...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/floor1.oel", __ASSET__assets_data_floor1_oel);
		type.set ("assets/data/floor1.oel", AssetType.TEXT);
		className.set ("assets/data/Halloween.oep", __ASSET__assets_data_halloween_oep);
		type.set ("assets/data/Halloween.oep", AssetType.TEXT);
		...
		className.set ("assets/images/WizardPlaceholder.png", __ASSET__assets_images_wizardplaceholder_png);
		type.set ("assets/images/WizardPlaceholder.png", AssetType.IMAGE);
		...
		id = "assets/data/floor1.oel";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/Halloween.oep";
		path.set (id, id);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/WizardPlaceholder.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_floor1_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_halloween_oep extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_wizardplaceholder_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/floor1.oel") #if display private #end class __ASSET__assets_data_floor1_oel extends lime.utils.Bytes {}
@:file("assets/data/Halloween.oep") #if display private #end class __ASSET__assets_data_halloween_oep extends lime.utils.Bytes {}
...
@:image("assets/images/WizardPlaceholder.png") #if display private #end class __ASSET__assets_images_wizardplaceholder_png extends lime.graphics.Image {}
